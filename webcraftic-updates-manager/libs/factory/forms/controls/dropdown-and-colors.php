<?php
	 ...
	 *  // see FactoryForms483_DropdownControl
	 * 'dropdown' => array(
	 ...
	 *    ),
	 * // see FactoryForms483_RadioColorsControl
	 * 'colors' => array(
	 *   // a callback to return items or an array of items to select
	 *   'data' => array(
	...
	if( !class_exists('Wbcr_FactoryForms483_DropdownAndColorsControl') ) {
		
		class Wbcr_FactoryForms483_DropdownAndColorsControl extends Wbcr_FactoryForms483_ComplexControl {
			...
			public function __construct($options, $form, $provider = null)
			{
				...
				$this->dropdown = new Wbcr_FactoryForms483_DropdownControl($options['dropdown'], $form, $provider);
				$this->colors = new Wbcr_FactoryForms483_RadioColorsControl($options['colors'], $form, $provider);
