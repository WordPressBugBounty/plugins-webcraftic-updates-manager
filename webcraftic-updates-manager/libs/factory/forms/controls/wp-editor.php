<?php
	...
	if( !class_exists('Wbcr_FactoryForms483_WpEditorControl') ) {

		class Wbcr_FactoryForms483_WpEditorControl extends Wbcr_FactoryForms483_Control {
			...
			protected function beforeHtml()
			{
				...
				if( !isset($this->options['tinymce']['content_css']) ) {
					$this->options['tinymce']['content_css'] = FACTORY_FORMS_483_URL . '/assets/css/editor.css';
				}
			}
