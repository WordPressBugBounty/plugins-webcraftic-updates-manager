<?php
	...
	if( !class_exists('Wbcr_FactoryForms483_TabHolder') ) {
		 ...
		 * @since 1.0.0
		 */
		class Wbcr_FactoryForms483_TabHolder extends Wbcr_FactoryForms483_Holder {
			 ...
			 * @param FactoryForms483_Form $form A parent form.
			 */
				...
				<div class="factory-headers">
					<ul class="nav nav-tabs">
						<?php foreach($this->elements as $element) {
							...
							$builder = new Wbcr_FactoryForms483_HtmlAttributeBuilder();
