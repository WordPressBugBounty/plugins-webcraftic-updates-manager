<?php
	...
	if( !class_exists('Wbcr_FactoryForms483_OptionsValueProvider') ) {
		 ...
		 * @since 1.0.0
		 */
		class Wbcr_FactoryForms483_OptionsValueProvider implements Wbcr_IFactoryForms483_ValueProvider {
