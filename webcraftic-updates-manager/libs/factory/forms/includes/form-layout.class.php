<?php
	...
	if( !class_exists('Wbcr_FactoryForms483_FormLayout') ) {

		/**
		 * The base class for all form layouts.
		 */
		abstract class Wbcr_FactoryForms483_FormLayout extends Wbcr_FactoryForms483_Holder {
			...
			public function __construct($options, $form)
			{
				...
				$this->addCssClass('factory-forms-483-' . $this->type);
				$this->addCssClass('factory-forms-483-' . $this->name);
			}
