<?php
	...
	if( !class_exists('Wbcr_FactoryForms483_FormElement') ) {
		 ...
		 * @since 1.0.0
		 */
		abstract class Wbcr_FactoryForms483_FormElement {
			 ...
			 *
			 * @since 1.0.0
			 * @var Wbcr_FactoryForms483_HtmlAttributeBuilder
			 */
			...
			public function __construct($options, $form)
			{
				...
				$this->html_builder = new Wbcr_FactoryForms483_HtmlAttributeBuilder();
