<?php
	...
	if( !class_exists('Wbcr_FactoryForms483_Bootstrap3FormLayout') ) {
		/**
		 * A form layout based on Twitter Bootstrap 3
		 */
		class Wbcr_FactoryForms483_Bootstrap3FormLayout extends Wbcr_FactoryForms483_FormLayout {
			...
			/**
			 * @param Wbcr_FactoryForms483_Control $control
			 */
