...
namespace WBCR\Factory_483\Components;
...
class Install_Button {
	 ...
	 * @since  4.3.3
	 */
	public function __construct(\Wbcr_Factory483_Plugin $plugin, $type, $plugin_slug)
	{
		...
		$this->add_data('i18n', \WBCR\Factory_Templates_137\Helpers::getEscapeJson($this->get_i18n()));
	...
	{
		return [
			'activate' => __('Activate', 'wbcr_factory_483'),
			'install' => __('Install', 'wbcr_factory_483'),
			'deactivate' => __('Deactivate', 'wbcr_factory_483'),
			'delete' => __('Delete', 'wbcr_factory_483'),
			'loading' => __('Please wait...', 'wbcr_factory_483'),
			'preparation' => __('Preparation...', 'wbcr_factory_483'),
			'read' => __('Read more', 'wbcr_factory_483')
		];
	}
