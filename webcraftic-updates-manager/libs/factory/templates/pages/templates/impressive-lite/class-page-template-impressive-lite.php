...
if ( ! class_exists( 'WBCR\Factory_Templates_137\ImpressiveLite' ) ) {
	/**
	 * Class Wbcr_FactoryPages483_ImpressiveLiteTemplate
	 */
	abstract class ImpressiveLite extends \WBCR\Factory_Templates_137\Pages\PageBase {
		...
		public function assets( $scripts, $styles ) {
			...
			$this->styles->add( FACTORY_TEMPLATES_137_URL . '/pages/templates/impressive-lite/assets/css/impressive-lite.page.template.css' );
		}
		...
		protected function showPageSubMenu() {
			...
			?>
            <div class="w-factory-templates-137-horizontal-menu wp-clearfix">
				<?php foreach ( (array) $page_menu as $page_screen => $page ): ?>
					...
					if ( $page_screen == $this->getResultId() ) {
						$active_tab = ' w-factory-templates-137-horizontal-menu__nav-tab-active';
					}
					?>
                    <a href="<?php echo $page['url'] ?>" id="<?php echo esc_attr( $page_screen ) ?>-tab"
                       class="w-factory-templates-137-horizontal-menu__nav-tab<?php echo esc_attr( $active_tab ) ?>">
		...
		protected function showOptions() {
            ...
            <div id="WBCR" class="wrap">
                <div class="wbcr-factory-templates-137-impressive-lite-page-template factory-bootstrap-485 factory-fontawesome-000">
                                    ...
                                    <form method="post" class="form-horizontal">
										...
										if ( $this->type == 'options' ) {
											...
											$submit_button = "<input name='{$this->plugin->getPluginName()}_save_action'
                                                   ...
                                                   value='" . __( 'Save', 'wbcr_factory_pages_483' ) . "'>";
										}
										?>
