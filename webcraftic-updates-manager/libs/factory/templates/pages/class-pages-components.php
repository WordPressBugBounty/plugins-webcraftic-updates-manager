...
class Components extends \WBCR\Factory_Templates_137\Pages\PageBase {
	...
	{
		$this->menu_title = __('Components', 'wbcr_factory_templates_137');
		$this->page_menu_short_description = __('More features for plugin', 'wbcr_factory_templates_137');
	...
	public function assets($scripts, $styles)
	{
		...
		$this->styles->add(FACTORY_TEMPLATES_137_URL . '/assets/css/components.css');
	 ...
	 *
	 * @return array
	 * @see libs\factory\pages\themplates\FactoryPages483_ImpressiveThemplate
	 */
	public function getActionNotices($notices)
	{
		$notices[] = [
			...
			'type' => 'success',
			'message' => __('Components have been successfully updated to the latest version.', 'wbcr_factory_templates_137')
		];
	...
	public function showPageContent()
	{
		...
		?>
		<div class="wbcr-factory-page-group-header"><?php _e('<strong>Plugin Components</strong>.', 'wbcr_factory_templates_137') ?>
			<p>
				<?php _e('These are components of the plugin bundle. When you activate the plugin, all the components turned on by default. If you don’t need some function, you can easily turn it off on this page.', 'wbcr_factory_templates_137') ?>
			</p>
		</div>
		<div class="wbc-factory-templates-137-components">
			<?php
			/**
			 * @since 1.4.0
			 */
